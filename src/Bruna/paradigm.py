...
class LeftRightImagery_(SinglePass):
    ...
    def __init__(self, metric='roc_auc', **kwargs):
        self.metric = metric
...
class MotorImagery_(SinglePass):
    """
    ...
    def __init__(self, n_classes=None, metric="roc_auc", **kwargs):
